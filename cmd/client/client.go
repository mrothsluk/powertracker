...
// Increased from 20s to 45s because my home server is a Pi 3B+ and is quite slow to respond,
// especially after a reboot or during high CPU usage from other services.
